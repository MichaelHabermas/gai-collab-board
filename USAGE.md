...
| Events | 78 |
| Requests | 3028 |
| Total tokens | 586.59M |
| Input tokens | 160.8k |
| Output tokens | 60.0k |
| Cache read | 566.36M |
| Cache create | 20.00M |
| Estimated cost | $1192.1629 |

## Segmented Totals by Source

| Source | Events | Requests | Total tokens | Input | Output | Cost |
|--------|--------|----------|--------------|-------|--------|------|
| Claude | 39 | 39 | 586.59M | 160.8k | 60.0k | $1190.6684 |
...
|------|--------|--------|------|
| 2026-02-21 | 20 | 134.15M | $275.1047 |
...
xychart-beta
    ...
    x-axis ["02-20 20:38", "02-20 22:40", "02-20 22:40", "02-20 23:34", "02-20 23:34", "02-21 00:42", "02-21 00:42", "02-21 01:17", "02-21 01:17", "02-21 08:35", "02-21 08:35", "02-21 08:43", "02-21 08:43", "02-21 08:48", "02-21 08:48"]
    y-axis "Tokens" 0 --> 23041
    line "Input" [0, 20946, 0, 11287, 0, 58, 0, 213, 0, 128, 0, 238, 0, 12, 0]
    line "Output" [0, 1894, 0, 2318, 0, 378, 0, 1624, 0, 599, 0, 1570, 0, 74, 0]
```
...
xychart-beta
    ...
    x-axis ["02-20 20:38", "02-20 22:40", "02-20 22:40", "02-20 23:34", "02-20 23:34", "02-21 00:42", "02-21 00:42", "02-21 01:17", "02-21 01:17", "02-21 08:35", "02-21 08:35", "02-21 08:43", "02-21 08:43", "02-21 08:48", "02-21 08:48"]
    y-axis "USD" 0 --> 291
    line "Cost" [0.0045000000000000005, 60.637539000000004, 0.0565, 74.7590402, 0.1145, 7.664612999999999, 0.011, 40.793046749999995, 0.054, 26.10212775, 0.0275, 51.90656625, 0.059500000000000004, 2.33877675, 0.001]
    line "Cumulative" [0.0045, 60.642, 60.6985, 135.4576, 135.5721, 143.2367, 143.2477, 184.0407, 184.0947, 210.1969, 210.2244, 262.1309, 262.1904, 264.5292, 264.5302]
```
...
xychart-beta
    ...
    x-axis ["02-20 20:38", "02-20 22:40", "02-20 22:40", "02-20 23:34", "02-20 23:34", "02-21 00:42", "02-21 00:42", "02-21 01:17", "02-21 01:17", "02-21 08:35", "02-21 08:35", "02-21 08:43", "02-21 08:43", "02-21 08:48", "02-21 08:48"]
    y-axis "USD" 0 --> 83
    line "Claude" [0, 60.637539000000004, 0, 74.7590402, 0, 7.664612999999999, 0, 40.793046749999995, 0, 26.10212775, 0, 51.90656625, 0, 2.33877675, 0]
...
|------|--------|----------|-------|----|-----|------|--------|
| 2026-02-21 13:48 | MCP tools | claude | mcp-tooling | 0 | 0 | $0.0010 | best_effort |
| 2026-02-21 13:48 | Claude | anthropic | claude-opus-4-6 | 12 | 74 | $2.3388 | best_effort |
...
---
*Last updated: 2026-02-21 13:48:28 UTC*
