...
| Events | 52 |
| Requests | 2145 |
| Total tokens | 415.12M |
| Input tokens | 70.0k |
| Output tokens | 48.1k |
| Cache read | 402.81M |
| Cache create | 12.20M |
| Estimated cost | $830.4382 |

## Segmented Totals by Source

| Source | Events | Requests | Total tokens | Input | Output | Cost |
|--------|--------|----------|--------------|-------|--------|------|
| Claude | 26 | 26 | 415.12M | 70.0k | 48.1k | $829.3787 |
| MCP tools | 26 | 2119 | 0 | 0 | 0 | $1.0595 |
...
|------|--------|--------|------|
| 2026-02-20 | 52 | 415.12M | $830.4382 |
...
xychart-beta
    ...
    x-axis ["02-20 13:20", "02-20 13:22", "02-20 13:22", "02-20 13:29", "02-20 13:29", "02-20 14:44", "02-20 14:44", "02-20 15:20", "02-20 15:20", "02-20 15:35", "02-20 15:35", "02-20 15:37", "02-20 15:37", "02-20 16:20", "02-20 16:20"]
    y-axis "Tokens" 0 --> 9843
    line "Input" [0, 8130, 0, 10, 0, 476, 0, 194, 0, 8948, 0, 34, 0, 2503, 0]
    line "Output" [0, 5442, 0, 40, 0, 2177, 0, 1270, 0, 1528, 0, 158, 0, 1846, 0]
```
...
xychart-beta
    ...
    x-axis ["02-20 13:20", "02-20 13:22", "02-20 13:22", "02-20 13:29", "02-20 13:29", "02-20 14:44", "02-20 14:44", "02-20 15:20", "02-20 15:20", "02-20 15:35", "02-20 15:35", "02-20 15:37", "02-20 15:37", "02-20 16:20", "02-20 16:20"]
    y-axis "USD" 0 --> 392
    line "Cost" [0.017, 168.20375775, 0.2005, 0.676962, 0.0005, 48.303068249999995, 0.056, 39.179916000000006, 0.043000000000000003, 52.24645875, 0.054, 4.876151999999999, 0.003, 41.55612825, 0.0525]
    line "Cumulative" [0.017, 168.2208, 168.4213, 169.0982, 169.0987, 217.4018, 217.4578, 256.6377, 256.6807, 308.9272, 308.9812, 313.8573, 313.8603, 355.4164, 355.4689]
```
...
xychart-beta
    ...
    x-axis ["02-20 13:20", "02-20 13:22", "02-20 13:22", "02-20 13:29", "02-20 13:29", "02-20 14:44", "02-20 14:44", "02-20 15:20", "02-20 15:20", "02-20 15:35", "02-20 15:35", "02-20 15:37", "02-20 15:37", "02-20 16:20", "02-20 16:20"]
    y-axis "USD" 0 --> 186
    line "Claude" [0, 168.20375775, 0, 0.676962, 0, 48.303068249999995, 0, 39.179916000000006, 0, 52.24645875, 0, 4.876151999999999, 0, 41.55612825, 0]
    ...
    line "MCP" [0.017, 0, 0.2005, 0, 0.0005, 0, 0.056, 0, 0.043000000000000003, 0, 0.054, 0, 0.003, 0, 0.0525]
```
...
|------|--------|----------|-------|----|-----|------|--------|
| 2026-02-20 21:20 | MCP tools | claude | mcp-tooling | 0 | 0 | $0.0525 | best_effort |
| 2026-02-20 21:20 | Claude | anthropic | claude-opus-4-6 | 2.5k | 1.8k | $41.5561 | best_effort |
...
---
*Last updated: 2026-02-20 21:20:42 UTC*
