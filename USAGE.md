...
| Events | 22 |
| Requests | 861 |
| Total tokens | 161.65M |
| Input tokens | 32.9k |
| Output tokens | 10.4k |
| Cache read | 157.47M |
| Cache create | 4.14M |
| Estimated cost | $315.4893 |

## Segmented Totals by Source

| Source | Events | Requests | Total tokens | Input | Output | Cost |
|--------|--------|----------|--------------|-------|--------|------|
| Claude | 11 | 11 | 161.65M | 32.9k | 10.4k | $315.0643 |
| MCP tools | 11 | 850 | 0 | 0 | 0 | $0.4250 |
...
|------|--------|--------|------|
| 2026-02-20 | 22 | 161.65M | $315.4893 |
...
xychart-beta
    ...
    x-axis ["02-20 00:03", "02-20 00:12", "02-20 00:12", "02-20 00:42", "02-20 00:42", "02-20 02:10", "02-20 02:10", "02-20 08:22", "02-20 08:22", "02-20 08:45", "02-20 08:45", "02-20 09:16", "02-20 09:16", "02-20 09:22", "02-20 09:22"]
    y-axis "Tokens" 0 --> 8313
    line "Input" [0, 302, 0, 38, 0, 526, 0, 50, 0, 20, 0, 7557, 0, 4317, 0]
    line "Output" [0, 1766, 0, 106, 0, 3326, 0, 558, 0, 111, 0, 3730, 0, 217, 0]
```
...
xychart-beta
    ...
    x-axis ["02-20 00:03", "02-20 00:12", "02-20 00:12", "02-20 00:42", "02-20 00:42", "02-20 02:10", "02-20 02:10", "02-20 08:22", "02-20 08:22", "02-20 08:45", "02-20 08:45", "02-20 09:16", "02-20 09:16", "02-20 09:22", "02-20 09:22"]
    y-axis "USD" 0 --> 314
    line "Cost" [0.0015, 59.945744250000004, 0.08750000000000001, 5.441724, 0.0085, 93.4174245, 0.1205, 6.139039500000001, 0.011, 1.37979225, 0.002, 113.82571275000001, 0.1525, 4.6012432500000005, 0.009000000000000001]
    line "Cumulative" [0.0015, 59.9472, 60.0347, 65.4765, 65.485, 158.9024, 159.0229, 165.1619, 165.1729, 166.5527, 166.5547, 280.3804, 280.5329, 285.1342, 285.1432]
```
...
xychart-beta
    ...
    x-axis ["02-20 00:03", "02-20 00:12", "02-20 00:12", "02-20 00:42", "02-20 00:42", "02-20 02:10", "02-20 02:10", "02-20 08:22", "02-20 08:22", "02-20 08:45", "02-20 08:45", "02-20 09:16", "02-20 09:16", "02-20 09:22", "02-20 09:22"]
    y-axis "USD" 0 --> 126
    line "Claude" [0, 59.945744250000004, 0, 5.441724, 0, 93.4174245, 0, 6.139039500000001, 0, 1.37979225, 0, 113.82571275000001, 0, 4.6012432500000005, 0]
    ...
    line "MCP" [0.0015, 0, 0.08750000000000001, 0, 0.0085, 0, 0.1205, 0, 0.011, 0, 0.002, 0, 0.1525, 0, 0.009000000000000001]
```
...
|------|--------|----------|-------|----|-----|------|--------|
| 2026-02-20 14:22 | MCP tools | claude | mcp-tooling | 0 | 0 | $0.0090 | best_effort |
| 2026-02-20 14:22 | Claude | anthropic | claude-opus-4-6 | 4.3k | 217 | $4.6012 | best_effort |
...
---
*Last updated: 2026-02-20 14:22:28 UTC*
