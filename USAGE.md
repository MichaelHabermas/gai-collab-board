...
| Events | 82 |
| Requests | 3090 |
| Total tokens | 596.77M |
| Input tokens | 183.9k |
| Output tokens | 61.1k |
| Cache read | 574.76M |
| Cache create | 21.77M |
| Estimated cost | $1233.5830 |

## Segmented Totals by Source

| Source | Events | Requests | Total tokens | Input | Output | Cost |
|--------|--------|----------|--------------|-------|--------|------|
| Claude | 41 | 41 | 596.77M | 183.9k | 61.1k | $1232.0585 |
...
|------|--------|--------|------|
| 2026-02-21 | 24 | 144.33M | $316.5247 |
...
xychart-beta
    ...
    x-axis ["02-20 23:34", "02-21 00:42", "02-21 00:42", "02-21 01:17", "02-21 01:17", "02-21 08:35", "02-21 08:35", "02-21 08:43", "02-21 08:43", "02-21 09:59", "02-21 09:59", "02-21 10:45", "02-21 10:45", "02-21 16:07", "02-21 16:07"]
    y-axis "Tokens" 0 --> 25302
    line "Input" [0, 58, 0, 213, 0, 128, 0, 238, 0, 73, 0, 23001, 0, 52, 0]
    line "Output" [0, 378, 0, 1624, 0, 599, 0, 1570, 0, 407, 0, 496, 0, 232, 0]
```
...
xychart-beta
    ...
    x-axis ["02-20 23:34", "02-21 00:42", "02-21 00:42", "02-21 01:17", "02-21 01:17", "02-21 08:35", "02-21 08:35", "02-21 08:43", "02-21 08:43", "02-21 09:59", "02-21 09:59", "02-21 10:45", "02-21 10:45", "02-21 16:07", "02-21 16:07"]
    y-axis "USD" 0 --> 188
    line "Cost" [0.1145, 7.664612999999999, 0.011, 40.793046749999995, 0.054, 26.10212775, 0.0275, 51.90656625, 0.059500000000000004, 13.722154249999999, 0.01, 17.360798250000002, 0.014, 12.645848650000001, 0.007]
    line "Cumulative" [0.1145, 7.7791, 7.7901, 48.5832, 48.6372, 74.7393, 74.7668, 126.6734, 126.7329, 140.455, 140.465, 157.8258, 157.8398, 170.4857, 170.4927]
```
...
xychart-beta
    ...
    x-axis ["02-20 23:34", "02-21 00:42", "02-21 00:42", "02-21 01:17", "02-21 01:17", "02-21 08:35", "02-21 08:35", "02-21 08:43", "02-21 08:43", "02-21 09:59", "02-21 09:59", "02-21 10:45", "02-21 10:45", "02-21 16:07", "02-21 16:07"]
    y-axis "USD" 0 --> 58
    line "Claude" [0, 7.664612999999999, 0, 40.793046749999995, 0, 26.10212775, 0, 51.90656625, 0, 13.722154249999999, 0, 17.360798250000002, 0, 12.645848650000001, 0]
...
|------|--------|----------|-------|----|-----|------|--------|
| 2026-02-21 21:07 | MCP tools | claude | mcp-tooling | 0 | 0 | $0.0070 | best_effort |
| 2026-02-21 21:07 | Claude | anthropic | claude-opus-4-6,<synthetic>,claude-haiku-4-5-20251001 | 52 | 232 | $12.6458 | best_effort |
...
---
*Last updated: 2026-02-21 21:07:06 UTC*
