...
| Events | 60 |
| Requests | 2421 |
| Total tokens | 467.78M |
| Input tokens | 141.2k |
| Output tokens | 52.3k |
| Cache read | 452.53M |
| Cache create | 15.06M |
| Estimated cost | $960.2236 |

## Segmented Totals by Source

| Source | Events | Requests | Total tokens | Input | Output | Cost |
|--------|--------|----------|--------------|-------|--------|------|
| Claude | 30 | 30 | 467.78M | 141.2k | 52.3k | $959.0281 |
| MCP tools | 30 | 2391 | 0 | 0 | 0 | $1.1955 |
...
|------|--------|--------|------|
| 2026-02-20 | 60 | 467.78M | $960.2236 |
...
xychart-beta
    ...
    x-axis ["02-20 15:20", "02-20 15:35", "02-20 15:35", "02-20 16:35", "02-20 16:35", "02-20 17:15", "02-20 17:15", "02-20 17:19", "02-20 17:19", "02-20 17:29", "02-20 17:29", "02-20 18:37", "02-20 18:37", "02-20 18:45", "02-20 18:45"]
    y-axis "Tokens" 0 --> 55668
    line "Input" [0, 8948, 0, 2552, 0, 179, 0, 28, 0, 50607, 0, 13381, 0, 6979, 0]
    line "Output" [0, 1528, 0, 2065, 0, 1163, 0, 114, 0, 1231, 0, 1253, 0, 317, 0]
```
...
xychart-beta
    ...
    x-axis ["02-20 15:20", "02-20 15:35", "02-20 15:35", "02-20 16:35", "02-20 16:35", "02-20 17:15", "02-20 17:15", "02-20 17:19", "02-20 17:19", "02-20 17:29", "02-20 17:29", "02-20 18:37", "02-20 18:37", "02-20 18:45", "02-20 18:45"]
    y-axis "USD" 0 --> 252
    line "Cost" [0.043000000000000003, 52.24645875, 0.054, 46.72079925, 0.058, 30.7421055, 0.035500000000000004, 2.8003875000000003, 0.005, 34.05879975, 0.046, 45.20010599999999, 0.037, 16.5594885, 0.01]
    line "Cumulative" [0.043, 52.2895, 52.3435, 99.0643, 99.1223, 129.8644, 129.8999, 132.7003, 132.7053, 166.7641, 166.8101, 212.0102, 212.0472, 228.6066, 228.6166]
```
...
xychart-beta
    ...
    x-axis ["02-20 15:20", "02-20 15:35", "02-20 15:35", "02-20 16:35", "02-20 16:35", "02-20 17:15", "02-20 17:15", "02-20 17:19", "02-20 17:19", "02-20 17:29", "02-20 17:29", "02-20 18:37", "02-20 18:37", "02-20 18:45", "02-20 18:45"]
    y-axis "USD" 0 --> 58
    line "Claude" [0, 52.24645875, 0, 46.72079925, 0, 30.7421055, 0, 2.8003875000000003, 0, 34.05879975, 0, 45.20010599999999, 0, 16.5594885, 0]
    ...
    line "MCP" [0.043000000000000003, 0, 0.054, 0, 0.058, 0, 0.035500000000000004, 0, 0.005, 0, 0.046, 0, 0.037, 0, 0.01]
```
...
|------|--------|----------|-------|----|-----|------|--------|
| 2026-02-20 23:45 | MCP tools | claude | mcp-tooling | 0 | 0 | $0.0100 | best_effort |
| 2026-02-20 23:45 | Claude | anthropic | claude-opus-4-6 | 7.0k | 317 | $16.5595 | best_effort |
...
---
*Last updated: 2026-02-20 23:45:23 UTC*
